      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form class="row g-3"  action="{{ url('products/create') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-md-6">
                    ...
                    <input rows="3" name="description" id="description" class="form-control" value="{{old('description')}}"></input>
                    @error('description')
                      <span class="text-danger">{{$message}}</span>
                    @enderror
                  </div>
                  <div class="form-group ">
                    ...
                    <textarea rows="5" name="detail_description" id="detail_description" class="form-control">{{old('detail_description')}}</textarea>
