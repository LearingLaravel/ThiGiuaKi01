...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="AT10 FOOD &raquo; MÙNG TƠI Dòng phản hồi"
        href="https://at10.mediawz.com/san-pham/mung-toi/feed/" />
...
<![endif]-->
    ...
    <link rel="alternate" type="application/json+oembed"
        href="https://at10.mediawz.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fat10.mediawz.com%2Fsan-pham%2Fmung-toi%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="https://at10.mediawz.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fat10.mediawz.com%2Fsan-pham%2Fmung-toi%2F&#038;format=xml" />
...
<body data-rsssl=1
    class="home page-template-default page page-id-2 wp-custom-logo theme-halinkat10 woocommerce-no-js twentyseventeen-front-page has-header-image page-two-column colors-light">
    <script>
    ...
    <div id="NavDrawer" class="drawer drawer--right">
        ...
        <ul id="menu-menu-chinh" class="mobile-nav">
            <li id="menu-item-19"
                ...
                <a class="mobile-nav__link" href="https://at10.mediawz.com/">Trang chủ</a></li>
            <li id="menu-item-130"
            ...
            <li id="menu-item-131"
                class="menu-item menu-item-type-post_type menu-item-object-page mobile-nav__item menu-item-131"><a
                    class="mobile-nav__link" href="https://at10.mediawz.com/san-pham/">Sản phẩm</a></li>
            <li id="menu-item-133"
    ...
    <div id="page" class="site">
                                    ...
                                    <div id="header-main-mn" class="hd-navbar">
                                        <ul id="menu-menu-chinh-1" class="no-bullets">
                                            ...
                                            <li
                                                ...
                                                <a href="https://at10.mediawz.com/san-pham/">Sản phẩm</a></li>
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-133">
                                                <a href="https://at10.mediawz.com/lien-he/">Liên hệ</a></li>
                                            <li
        ...
        <div id="PageContainer" class="is-moved-by-drawer">
                    ...
                    <article id="post-2"
                        ...
                        <div id="main-slider">
                            <div class="main-slide"
                                style="background-image: url(https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img1.jpg);">
                                <div class="wrapper">
                                    <div class="main-content text-center">
                                        <div>
                                            <div class="slider-text" data-animation="fadeInDown" data-delay="0.5s">
                                                <div class="slider-text-bold">Thực phẩm hữu cơ 1</div>
                                                <div class="slider-text-nor">Tốt cho sức khỏe, tốt cho cuộc sống 1
                                                </div>
                                            </div>
                            ...
                            <div class="main-slide"
                                style="background-image: url(https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img2.jpg);">
                                <div class="wrapper">
                                    <div class="main-content text-center">
                                        <div>
                                            <div class="slider-text" data-animation="fadeInDown" data-delay="0.5s">
                                                <div class="slider-text-bold">Thực phẩm hữu cơ 2</div>
                                                <div class="slider-text-nor">Tốt cho sức khỏe, tốt cho cuộc sống 2
                                                </div>
                                            </div>
                                            <div class="slider-button">
                                                <!-- <a class="btnHome btn-shopNow" href="#" data-animation="fadeInLeftBig" data-delay="0.5s">Xem ngay</a>
                            ...
                            <div class="main-slide"
                                style="background-image: url(https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img3.jpg);">
                                <div class="wrapper">
                                    <div class="main-content text-center">
                                        <div>
                                            <div class="slider-text" data-animation="fadeInDown" data-delay="0.5s">
                                                <div class="slider-text-bold">Thực phẩm hữu cơ 3</div>
                                                <div class="slider-text-nor">Tốt cho sức khỏe, tốt cho cuộc sống 3
                                                </div>
                                            </div>
                                            <div class="slider-button">
                                                <!-- <a class="btnHome btn-shopNow" href="#" data-animation="fadeInLeftBig" data-delay="0.5s">Xem ngay</a>
                                        ...
                                        <div class="footer-logo text-center">
                                            ...
                                            <div class="ft-social-network">
                                                ...
                                                <a target="_blank" href="#gp" class="gg-icon"><svg
                                                        ...
                                                        aria-hidden="true" data-prefix="fab" data-icon="google-plus"
                                                        role="img" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div id="w366-footer-main" class="grid-uniform">
                                            <section id="w366_footer_contact-2"
                                                ...
                                                <div class="footer-info">
                                                    ...
                                                    <ul class="no-bullets">
                                                        <li>
                                                            <svg class="svg-inline--fa fa-map-marker fa-w-12"
                                                                aria-hidden="true" data-prefix="fa"
                                                                data-icon="map-marker" role="img"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <li>
                                                            ...
                                                            </svg><!-- <i class="fa fa-envelope" aria-hidden="true"></i> -->
                                                ...
                                                <div class="menu-footer-1-container">
                                                    <ul id="menu-footer-1" class="menu">
                                                        <li id="menu-item-60"
                                                            ...
                                                            <a href="https://at10.mediawz.com/kinh-nghiem-mua-hang/">Kinh
                                                                nghiệm mua hàng</a></li>
                                                        <li id="menu-item-61"
                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-61">
                                                            <a href="https://at10.mediawz.com/huong-dan-mua-hang/">Hướng
                                                                dẫn mua hàng</a></li>
                                                        <li id="menu-item-59"
                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-59">
                                                            <a href="https://at10.mediawz.com/chinh-sach-doi-tra/">Chính
                                                                sách đổi trả</a></li>
                                                        <li id="menu-item-58"
                                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-58">
                                                            <a href="https://at10.mediawz.com/hinh-thuc-thanh-toan/">Hình
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="gallery-item">
                                                                <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img3.jpg"
                                                                    ...
                                                                    data-fancybox-group="gallery65ffee0fbec53"
            ...
            <div id="back-to-top" class="medium--hide small--hide">
                ...
                <a href="javascript:void(0)"><svg class="svg-inline--fa fa-angle-double-up fa-w-10"
                        aria-hidden="true" data-prefix="fa" data-icon="angle-double-up" role="img"
